...
pixi add rocr-runtime
# for installing globally
pixi global install rocr-runtime
```
...
It is possible to list all of the versions of `rocr-runtime` available on your platform:
...
```
pixi search rocr-runtime --channel conda-forge
```
